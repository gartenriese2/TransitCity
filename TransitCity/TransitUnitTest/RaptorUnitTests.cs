...
namespace TransitUnitTest
{
    ...
    public class RaptorUnitTests
    {
        ...
        public void TestReverse()
        {
            ...
            var connectionList = raptor.Compute(source, departure, target, Speed.FromKilometersPerHour(8));
            var arrival = connectionList.Last().TargetTime;
            var reverseConnectionList = raptor.ComputeReverse(source, arrival, target, Speed.FromKilometersPerHour(8));
